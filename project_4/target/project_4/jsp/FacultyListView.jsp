	...
	<center>
		...
		<form action="<%=ORSView.FACULTY_LIST_CTL%>" method="POST">
			...
			<table>
				<tr>
					<td>
						<label class="p1">Email_Id</label>&emsp;<input type="text"
						placeholder="Enter EmailId" size="20" name="login"
					 ...
					 <label class="p1">College Name</label> <%=HTMLUtility.getList("collegeId", String.valueOf(bean.getCollegeId()), list1)%>&emsp;
						...
						<label class="p1">Course Name</label> <%=HTMLUtility.getList("courseId", String.valueOf(bean.getCourseId()), list2)%>&emsp;&emsp;
