...
<body>
	...
	<tr>
		<td align="center">
		<label class="p1"> FirstName :</label> <input type="text" name="firstName" placeholder="Enter First Name"
		value="<%=ServletUtility.getParameter("firstName", request)%>">&emsp;&emsp;
						&emsp;&emsp;
		<label class="p1">Email_Id :</label> <input type="text" name="email" placeholder="Enter EmailId"
