...
public class TimeTableModel {
	...
	public long add(TimeTableBean bean) throws Exception{
		...
		System.out.println("course id course name and subject name"+bean.getCourseId()+""+bean.getCourseName()+""+bean.getSubId()+""+bean.getSubName());
	...
	public void update(TimeTableBean bean) throws DuplicateRecordException, ApplicationException{
		...
		try{
			...
			PreparedStatement stmt=conn.prepareStatement("Update st_timetable set Sub_id=?,Sub_name=?,Course_Id=?,Course_Name=?,Semester=?,Exam_Date=?,Exam_Time=?,Description=?,created_by=?,modified_by=?,created_datetime=?,modified_datetime=? where id=?");
