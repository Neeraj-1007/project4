...
public class EmailBuilder {
	...
	public static String getUserRegistrationMessage(HashMap<String, String> Map) {
		...
		System.out.println("In emailbuilder-method-UserRegistrationMessage");
		...
		System.out.println("Out of emailbuilder-method-UserRegistrationMessage");
		return msg.toString();
	}

	public static String getForgetPasswordMessage(HashMap<String, String> map) {

		System.out.println("In-Email Builder- ForgetPasswordMessage");
		StringBuilder msg = new StringBuilder();
		...
		msg.append("</body></html>");
		System.out.println("out-EmailBuider-ForgetPassword");
		return msg.toString();
	}

	public static String getChangePasswordMessage(HashMap<String, String> map) {
		StringBuilder msg = new StringBuilder();
		System.out.println("In-EmailBuider-ChangePassword");
		msg.append("<html><body>");
		...
		msg.append("<p><b>To access account user Login Id : " + map.get("login") + "<br>" + " Password : "
				+ map.get("password") + "</b></p>");
		msg.append("</body></html>");
		System.out.println("out-EmailBuider-ChangePassword");
		return msg.toString();
	}
